"""Native MLX ModernBERT encoder and Laya decision heads (inference only).

Vendored from mizorewww/laya-mlx@0a859518634112655cb97c745dbf04f5191aaf13,
laya_mlx/model.py (Apache-2.0; see NOTICE). Only this docstring differs from the source;
the Phase -1 MLX parity results (research/phase-0-feasibility/parity.md) apply unchanged.
"""
